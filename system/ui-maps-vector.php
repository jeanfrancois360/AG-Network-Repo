...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/ui-maps-vector.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:13:47 GMT -->
<head>
    <meta charset="utf-8">
...
<body class=" layout-fluid ui">
    ...
    <div class="mdk-header-layout js-mdk-header-layout">
                        ...
                        <div class="card-columns">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="world-map-markers" data-toggle="vector-world-map-markers" class="vector-map-cnt"></div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body">
                                    <h4>Gross domestic product (GDP) by country</h4>
                                    <div id="world-map-gdp" data-toggle="vector-world-map-gdp" class="vector-map-cnt"></div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body">
                                    <h4>USA unemployment</h4>
                                    <div id="usa-unemployment" data-toggle="vector-usa-unemployment" class="vector-map-cnt"></div>
                                    <p class="h5" id="usa-unemployment-slider-year">Data for <strong>2009</strong></p>

                                    <div id="usa-unemployment-slider" class="slider-single slider-primary"></div>
                                    <p>The following example demonstrates the visualization of unemployment statistics in the USA by states and metropolitan areas in a 5-years time-period. The step-by-step process of creation of such a map is described in the <a href="tutorials/data-visualization/index.php">tutorial</a>. The code in Ruby used to convert data could be found in <a href="https://github.com/bjornd/jvectormap-examples/tree/master/us-unemployment">this repository</a>.</p>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body">
                                    <h4>Regions selection</h4>
                                    <div id="regions-selection" data-toggle="vector-region-selection" class="vector-map-cnt"></div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div data-toggle="vector-france-elections">
                                        <div id="france-2007" class="vector-map-cnt"></div>
                                        ...
                                        <div id="france-2012" class="vector-map-cnt"></div>
                                        <div class="jvm-legend">
                                            <span class="jvm-legend-item jvm-legend-item-ps"></span>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <hr />
                                    <div id="random-colors-map" data-toggle="vector-random-colors" class="vector-map-cnt"></div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="mall-map" data-toggle="vector-mall-map" class="vector-map-cnt"></div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="projection-map" data-toggle="vector-projection-map" class="vector-map-cnt"></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <a class="sidebar-menu-button" href="ui-modals.php">
          <span class="sidebar-menu-text">- Modals</span>
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="fixed-ui-maps-vector.php">
      ...
      'fixed': 'fixed-ui-maps-vector.html',
      'default': 'ui-maps-vector.html'
...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/ui-maps-vector.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:14:40 GMT -->
</html>