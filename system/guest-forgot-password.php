...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/guest-forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:11:17 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div class="d-flex align-items-center" style="min-height: 100vh">
        <div class="col-sm-8 col-md-6 col-lg-4 mx-auto" style="min-width: 300px;">
            ...
            <div class="d-flex justify-content-center mb-5 navbar-light">
                <!-- Brand -->
                <a href="student-dashboard.php" class="navbar-brand m-0">
                    LearnPlus
                </a>
            </div>
