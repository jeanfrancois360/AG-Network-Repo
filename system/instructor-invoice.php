...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/instructor-invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:11:27 GMT -->
<head>
    <meta charset="utf-8">
...
<body class=" layout-fluid">
    ...
    <div class="mdk-header-layout js-mdk-header-layout">
                                    ...
                                    <div class="card">
                                        <div class="card-header media align-items-center">
                                            ...
                                            <div class="media-right d-flex align-items-center">
                                                <a href="javascript:window.print()" class="btn btn-flush text-muted d-print-none"><i class="material-icons font-size-24pt">print</i></a>
                                ...
                                <div data-perfect-scrollbar>
                                    <div class="page-section pt-lg-32pt">
                                        <nav class="nav page-nav__menu">
                                            <a href="instructor-invoice.php" class="nav-link active">View Invoice</a>
                                            <a href="instructor-edit-invoice.php" class="nav-link">Edit Invoice</a>
        ...
        <a class="sidebar-menu-button" href="ui-modals.php">
          <span class="sidebar-menu-text">- Modals</span>
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="fixed-instructor-invoice.php">
      ...
      'fixed': 'fixed-instructor-invoice.html',
      'default': 'instructor-invoice.html'
...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/instructor-invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:11:37 GMT -->
</html>