...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/student-messages.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:10:05 GMT -->
<head>
    <meta charset="utf-8">
                                            ...
                                            <ul class="list-group list-group-fit mb-3">
                                                ...
                                                <li class="list-group-item px-4 py-3 bg-light">
                                                    <a href="#" class="d-flex align-items-center position-relative">
                                                        ...
                                                        <span class="flex d-flex flex-column" style="max-width: 175px;">
                                                            <strong class="text-body">Mugabo Smith</strong>
                                                ...
                                                <li class="list-group-item px-4 py-3">
                                                    <a href="#" class="d-flex align-items-center position-relative">
                                                        ...
                                                        <span class="avatar-title rounded-circle">KL</span>

                                                        </span>
                                                        <span class="flex d-flex flex-column" style="max-width: 175px;">
                                                            <strong class="text-body">Kwizera Leo</strong>
                                                ...
                                                <li class="list-group-item px-4 py-3">
                                                    <a href="#" class="d-flex align-items-center position-relative">
                                                        ...
                                                        <span class="avatar-title rounded-circle">IJ</span>

                                                        </span>
                                                        <span class="flex d-flex flex-column" style="max-width: 175px;">
                                                            <strong class="text-body">Izere Johnson</strong>
                                            ...
                                            <ul class="list-group list-group-fit mb-3">
                                                ...
                                                <li class="list-group-item px-4 py-3">
                                                    <a href="#" class="d-flex align-items-center position-relative">
                                                        <span class="avatar avatar-sm avatar-offline mr-3 flex-shrink-0">
                                                            ...
                                                            <span class="avatar-title rounded-circle">KK</span>

                                                        </span>
                                                        <span class="flex d-flex flex-column" style="max-width: 175px;">
                                                            <strong class="text-body">kananura Kenny</strong>
                                                ...
                                                <li class="list-group-item px-4 py-3">
                                                    <a href="#" class="d-flex align-items-center position-relative">
                                                        ...
                                                        <span class="avatar-title rounded-circle">HJ</span>

                                                        </span>
                                                        <span class="flex d-flex flex-column" style="max-width: 175px;">
                                                            <strong class="text-body">Himbaza Jovitah</strong>
                                                ...
                                                <li class="list-group-item px-4 py-3">
                                                    <a href="#" class="d-flex align-items-center position-relative">
                                                        ...
                                                        <span class="avatar-title rounded-circle">MC</span>

                                                        </span>
                                                        <span class="flex d-flex flex-column" style="max-width: 175px;">
                                                            <strong class="text-body">Manzi Christian</strong>
                                                ...
                                                <li class="list-group-item px-4 py-3 bg-light">
                                                    <a href="#" class="d-flex align-items-center position-relative">
                                                        ...
                                                        <span class="flex d-flex flex-column" style="max-width: 175px;">
                                                            <strong class="text-body">Baho Roxy</strong>
                                                ...
                                                <li class="list-group-item px-4 py-3">
                                                    <a href="#" class="d-flex align-items-center position-relative">
                                                        ...
                                                        <span class="flex d-flex flex-column" style="max-width: 175px;">
                                                            <strong class="text-body">Shyaka Miguel</strong>
...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/student-messages.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:10:15 GMT -->
</html>