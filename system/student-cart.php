...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/student-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:10:01 GMT -->
<head>
    <meta charset="utf-8">
...
<body class=" layout-fluid">
    ...
    <div class="mdk-header-layout js-mdk-header-layout">
                ...
                <nav id="default-navbar" class="navbar navbar-expand navbar-dark bg-primary m-0">
                    <div class="container-fluid">
                        ...
                        <ul class="nav navbar-nav flex-nowrap">
                            ...
                            <li class="nav-item d-none d-md-flex active">
                            ...
                            <table class="table table-nowrap mb-0 table--elevated">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="student-view-course.php" class="avatar avatar-4by3 avatar-sm mr-3">
                                                    <img src="assets/images/lesson1.png" alt="Learn Vue.js Fundamentals" class="avatar-img rounded">
                                                </a>
                                        ...
                                        <td class="text-right">
                                            <p class="mb-0">&dollar;20.00 USD</p>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="student-view-course.php" class="avatar avatar-4by3 avatar-sm mr-3">
                                                    <img src="assets/images/lesson4.png" alt="Angular in Steps" class="avatar-img rounded">
                                                </a>
                                                <div class="media-body">
                                        ...
                                        <td class="text-right">
                                            ...
                                            <small class="text-black-50"><strong>Total</strong>: &dollar;40 USD</small>
                            ...
                            <table class="table mb-0">
                                <tfoot>
                                    <tr>
                                        ...
                                        <td style="width: 100px;" class="text-right"><strong>&dollar;40 USD</strong></td>
                                    </tr>
                                    <tr>
                                        <td class="text-right text-black-70"><strong>20% Discount</strong></td>
                                        <td style="width: 100px;" class="text-right"><strong>-&dollar;8 USD</strong></td>
                                    </tr>
                                    <tr>
                                        <td class="text-right text-black-70"><strong>Total</strong></td>
                                        <td style="width: 100px;" class="text-right"><strong>&dollar;32 USD</strong></td>
                                    </tr>
                                </tfoot>
                            </table>
                            <div class="card-footer d-flex align-items-center">
                                <a href="student-browse-courses.php" class="btn btn-white">Back to Courses</a>
                                <a href="student-pay.php" class="btn btn-success ml-auto">
          ...
          <span class="sidebar-menu-text">- Modals</span>
                                ...
                                <ul class="sidebar-menu">
                                    <li class="sidebar-menu-item active">
                                        <a class="sidebar-menu-button" href="student-cart.php">
                                            <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">dashboard</i> Fluid Layout
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="fixed-student-cart.php">
      ...
      'fixed': 'fixed-student-cart.html',
      'default': 'student-cart.html'
...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/student-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:10:05 GMT -->
</html>