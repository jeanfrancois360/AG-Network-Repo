...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/instructor-messages-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:15:08 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="app-messages layout-fluid">
                                ...
                                <ul class="d-flex flex-column list-unstyled" id="messages">
                                    ...
                                    <li class="message d-inline-flex">
                                        <div class="message__aside">
                                            <a href="instructor-profile.php" class="avatar">
                                        ...
                                        <div class="message__body card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex mr-3">
                                                        <a href="instructor-profile.php" class="text-body"><strong>Kananura Kenny</strong></a>
                                                    </div>
                                                    <div>
                                    ...
                                    <li class="message d-inline-flex">
                                        ...
                                        <div class="message__body card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex mr-3">
                                                        <a href="instructor-profile.php" class="text-body"><strong>Manzi Christian</strong></a>
                                                    </div>
                                                    <div>
                                                        <small class="text-muted">5 minutes ago</small>
                                                    </div>
        ...
        <a class="sidebar-menu-button" href="ui-modals.php">
          <span class="sidebar-menu-text">- Modals</span>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="fixed-instructor-messages-2.php">
    ...
    <div class="message__body card">
      <div class="card-body">
        <div class="d-flex align-items-center">
          <div class="flex mr-3">
            <a href="instructor-profile.php" class="text-body"><strong>{{:name}}</strong></a>
          </div>
          <div>
...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/instructor-messages-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:15:10 GMT -->
</html>