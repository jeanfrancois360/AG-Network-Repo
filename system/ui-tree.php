...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/ui-tree.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:13:39 GMT -->
<head>
    <meta charset="utf-8">
...
<body class=" layout-fluid ui">
    ...
    <div class="mdk-header-layout js-mdk-header-layout">
            ...
            <div data-push data-responsive-width="992px" class="mdk-drawer-layout js-mdk-drawer-layout">
                <div class="mdk-drawer-layout__content page ">
                    ...
                    <div class="container-fluid page__container">
                        ...
                        <h1 class="h2">Fancytree</h1>
                        <p>Fancytree is a JavaScript dynamic tree view plugin for jQuery with support for persistence,
                            keyboard, checkboxes, tables, drag and drop, and lazy loading. Fancytree is a sequel of the popular DynaTree plugin.</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Multiple Selection</h4>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Single Selection</h4>
                                    </div>
                                    <div class="card-body">
        ...
        <a class="sidebar-menu-button" href="ui-modals.php">
          <span class="sidebar-menu-text">- Modals</span>
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="fixed-ui-tree.php">
      ...
      'fixed': 'fixed-ui-tree.html',
      'default': 'ui-tree.html'
...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/ui-tree.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:13:47 GMT -->
</html>