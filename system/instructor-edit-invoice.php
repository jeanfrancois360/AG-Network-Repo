...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/instructor-edit-invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:11:37 GMT -->
<head>
    <meta charset="utf-8">
...
<body class=" layout-fluid">
    ...
    <div class="mdk-header-layout js-mdk-header-layout">
                ...
                <nav id="default-navbar" class="navbar navbar-expand navbar-dark bg-primary m-0">
                    <div class="container-fluid">
                        ...
                        <ul class="nav navbar-nav flex-nowrap d-none d-lg-flex">
                            <li class="nav-item">
                                <a class="nav-link" href="instructor-forum.php">Forum</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="instructor-help-center.php">Get Help</a>
                            </li>
                        </ul>
                        ...
                        <ul class="nav navbar-nav flex-nowrap">
                            ...
                            <li class="nav-item d-none d-md-flex">
                                <a href="instructor-cart.php" class="nav-link">
        ...
        <div class="mdk-header-layout__content">
                            ...
                            <div class="col-lg container-fluid page__container">
                                ...
                                <form action="#">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="form-row align-items-center">
                                                <div class="col-md-6">
                                                    <div class="form-group m-0" role="group" aria-labelledby="label-number">
                                                        <label id="label-number" for="number" class="form-label">Invoice Number</label>
                                                        <input id="number" type="text" placeholder="Invoice number ..." value="10003578" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group m-0" role="group" aria-labelledby="label-date">
                                                        <label id="label-date" for="date" class="form-label">Invoice Date</label>
                                                        <input id="date" type="text" class="form-control" placeholder="Invoice Date" data-toggle="flatpickr" value="today">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card table-responsive">
                                        <table class="table mb-0 table--elevated" id="table">
                                            <thead class="thead-light">
                                                <tr>
                                                    <th style="width: 18px;">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input js-toggle-check-all" data-target="#table" id="customCheckAll">
                                                            <label class="custom-control-label" for="customCheckAll"><span class="sr-only">Toggle all</span></label>
                                                        </div>
                                                    </th>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="custom-control custom-checkbox">
                                                            ...
                                                            <label class="custom-control-label" for="customCheck1_1"><span class="sr-only">Check</span></label>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <a href="instructor-view-course.php" class="avatar avatar-4by3 avatar-sm mr-3">
                                                                <img src="assets/images/lesson1.png" alt="Learn Angular Fundamentals" class="avatar-img rounded">
                                                            </a>
                                                            <div class="flex">
                                                                <a href="instructor-view-course.php" class="text-body">
          ...
          <td class="text-right"><strong>&dollar;9 USD</strong></td>
        </tr>
        <tr>
          <td><strong>Credit discount</strong></td>
          <td class="text-right"><strong>-&dollar;5 USD</strong></td>
        </tr> -->
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table mb-0">
                                            <tfoot>
                                                <tr>
                                                    <td style="width: 18px;" class="align-middle">
                                                        <div class="custom-control custom-checkbox disabled">
                                                            <input type="checkbox" class="custom-control-input js-check-selected-row" id="customCheck1_new">
                                                            <label class="custom-control-label" for="customCheck1_new"><span class="sr-only">Check</span></label>
                                                        </div>
                                                    </td>
                                                    <td class="align-middle">
                                                        <input type="text" class="form-control form-control-flush" placeholder="Enter item ...">
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="form-row align-items-center">
                                                <div class="col-md-6">
                                                    <div class="form-group m-0" role="group" aria-labelledby="label-discount">
                                                        <label id="label-discount" for="discount" class="form-label">Discount</label>
                                                        <input id="number" type="text" placeholder="Enter amount i.e. 12.5% or 12.50" value="5.00" class="form-control">
                                                        <small id="description-discount" class="form-text text-muted">Enter amount i.e. 12.5% or 12.50</small>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <table class="table mb-0 table-borderless">
                                                        <tfoot>
                                                            ...
                                                            <tr>
                                                                <td class="text-right text-black-70"><strong>Discount</strong></td>
                                                                <td style="width: 120px;" class="text-right"><strong>-&dollar;5.00 USD</strong></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-right text-black-70"><strong>Total</strong></td>
                                                                <td style="width: 120px;" class="text-right"><strong>&dollar;84.00 USD</strong></td>
                                                            </tr>
                                                        </tfoot>
                                                    </table>
                                                </div>
                                ...
                                <div data-perfect-scrollbar>
                                    <div class="page-section pt-lg-32pt">
                                        <nav class="nav page-nav__menu">
                                            <a href="instructor-invoice.php" class="nav-link">View Invoice</a>
                                            <a href="instructor-edit-invoice.php" class="nav-link active">Edit Invoice</a>
                                            <a href="instructor-invoice-settings.php" class="disabled nav-link">Invoice Settings</a>
                                        </nav>
                    ...
                    <div class="mdk-drawer__content ">
                        <div class="sidebar sidebar-left sidebar-dark bg-dark o-hidden" data-perfect-scrollbar>
                            <div class="sidebar-p-y">
                                ...
                                <ul class="sidebar-menu">
                                    <li class="sidebar-menu-item open">
                                        ...
                                        <ul class="sidebar-submenu sm-indent collapse show" id="account_menu">
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="guest-login.php">
                                                    <span class="sidebar-menu-text">Login</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="guest-signup.php">
                                                    <span class="sidebar-menu-text">Sign Up</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="guest-forgot-password.php">
                                                    <span class="sidebar-menu-text">Forgot Password</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="instructor-account-edit.php">
                                                    <span class="sidebar-menu-text">Edit Account</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="student-account-edit-basic.php">
                                                    <span class="sidebar-menu-text">Basic Information</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="student-account-edit-profile.php">
                                                    <span class="sidebar-menu-text">Profile &amp; Privacy</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="student-account-billing-subscription.php">
                                                    <span class="sidebar-menu-text">Subscription</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="student-account-billing-upgrade.php">
                                                    <span class="sidebar-menu-text">Upgrade Account</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="student-account-billing-payment-information.php">
                                                    <span class="sidebar-menu-text">Payment Information</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="student-billing.php">
                                                    <span class="sidebar-menu-text">Payment History</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="student-invoice.php">
                                                    <span class="sidebar-menu-text">Student Invoice</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="instructor-invoice.php">
                                                    <span class="sidebar-menu-text">Instructor Invoice</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item active">
                                                <a class="sidebar-menu-button" href="instructor-edit-invoice.php">
                                    ...
                                    <li class="sidebar-menu-item">
                                        ...
                                        <ul class="sidebar-submenu sm-indent collapse" id="messages_menu">
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="instructor-messages.php">
                                            ...
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="instructor-messages-2.php">
                                ...
                                <ul class="sidebar-menu sm-active-button-bg">
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="instructor-browse-courses.php">
                                            <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">search</i> Browse Courses
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="instructor-view-course.php">
                                            <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">import_contacts</i> View Course
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="instructor-take-course.php">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="instructor-take-quiz.php">
                                            <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">dvr</i> Take a Quiz
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="instructor-quiz-results.php">
                                            <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">poll</i> Quiz Results
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="instructor-my-courses.php">
                                    ...
                                    <li class="sidebar-menu-item">
                                        ...
                                        <ul class="sidebar-submenu sm-indent collapse" id="forum_menu">
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="instructor-forum.php">
                                                    <span class="sidebar-menu-text">Forum</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="instructor-forum-thread.php">
                                                    <span class="sidebar-menu-text">Discussion</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="instructor-forum-ask.php">
                                            ...
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="student-profile-posts.php">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="instructor-help-center.php">
        ...
        <a class="sidebar-menu-button" href="ui-modals.php">
          <span class="sidebar-menu-text">- Modals</span>
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="fixed-instructor-edit-invoice.php">
      ...
      'fixed': 'fixed-instructor-edit-invoice.html',
      'default': 'instructor-edit-invoice.html'
...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/instructor-edit-invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:11:49 GMT -->
</html>