                                            ...
                                            <tbody class="list">
                                                    ...
                                                    <td>
                                                        <div class="media align-items-center">
                                                            ...
                                                            <div class="media-body">
                                                                <a class="text-body js-lists-values-course" href="instructor-course-edit.php"><strong>Accounting for Agribusiness</strong></a><br>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="media align-items-center">
                                                            <a href="instructor-course-edit.php" class="avatar avatar-4by3 avatar-sm mr-3">
                                                                <img src="assets/images/lesson3.png" alt="course" class="avatar-img rounded">
                                                            </a>
                                                            <div class="media-body">
                                                                <a class="text-body js-lists-values-course" href="instructor-course-edit.php"><strong>Law and Agribusiness</strong></a><br>
                                                                <small class="text-muted mr-1">
                                                                    Invoice
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="media align-items-center">
                                                            ...
                                                            <div class="media-body">
                                                                <a class="text-body js-lists-values-course" href="instructor-course-edit.php"><strong>Business Management for Agriculture</strong></a><br>
                                                                <small class="text-muted mr-1">
                                                                    Invoice
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="media align-items-center">
                                                            ...
                                                            <div class="media-body">
                                                                <a class="text-body js-lists-values-course" href="instructor-course-edit.php"><strong>The Economics of Agribusiness</strong></a><br>
                                                                <small class="text-muted mr-1">
                                                                    Invoice
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center">
                                        ...
                                        <a class="btn btn-sm btn-success" href="instructor-earnings.php">Earnings</a>
                                    </div>
                                    <ul class="list-group list-group-fit mb-0">
                                        <li class="list-group-item">
                                            <div class="media align-items-center">
                                                <div class="media-body">
                                                    <a href="instructor-course-edit.php" class="text-body"><strong>Accounting for Agribusiness</strong></a>
                                                </div>
                                        ...
                                        <li class="list-group-item">
                                            <div class="media align-items-center">
                                                <div class="media-body">
                                                    <a href="instructor-course-edit.php" class="text-body"><strong>Business Management for Agriculture</strong></a>
                                                </div>
                                                <div class="media-right">
                                                    <div class="text-center">
                                        ...
                                        <li class="list-group-item">
                                            <div class="media align-items-center">
                                                <div class="media-body">
                                                    <a href="instructor-course-edit.php" class="text-body"><strong>Law and Agribusiness</strong></a>
                                                </div>
                                                <div class="media-right">
                                                    <div class="text-center">
                                        ...
                                        <li class="list-group-item">
                                            <div class="media align-items-center">
                                                <div class="media-body">
                                                    <a href="instructor-course-edit.php" class="text-body"><strong>The Economics of Agribusiness</strong></a>
                                                </div>
                                                <div class="media-right">
                                                    <div class="text-center">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-left">
                                                <a href="#" class="avatar avatar-sm">
                                                    <img src="assets/images/people/110/person.png" alt="Guy" class="avatar-img rounded-circle">
                                                </a>
                                            </div>
                                        ...
                                        <div class="media ml-sm-32pt mt-3 border rounded p-3 bg-light">
                                            ...
                                            <div class="media-body">
                                                <div class="d-flex align-items-center">
                                                    <a href="instructor-profile.php" class="text-body"><strong>Murekezi Henry</strong></a>
                                                    <small class="ml-auto text-muted">just now</small>
                                                </div>
                                                <p class="mt-1 mb-0 text-black-70">Hi Kenny,<br> Thank you for purchasing our course! <br><br>Please have a look at the charts library documentation <a href="#">here</a> and follow the instructions.</p>
                                            </div>
                                        </div>
                                    </div>
