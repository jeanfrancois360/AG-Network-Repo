...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/student-messages-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:11:49 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="app-messages layout-fluid">
    ...
    <div class="mdk-header-layout js-mdk-header-layout">
                                ...
                                <div class="nav py-2">
                                    <div class="nav-item align-items-center mr-3">
                                        ...
                                        <div class="d-flex flex-column" style="max-width: 200px; font-size: 15px">
                                            <strong class="text-body">Tonny Mugisha</strong>
                            ...
                            <div class="container-fluid page__container">
                                <div class="jumbotron">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex">
                                            <h4 class="mb-0">Tonny Mugisha</h4>
                                ...
                                <ul class="d-flex flex-column list-unstyled" id="messages">
                                    ...
                                    <li class="message d-inline-flex">
                                        <div class="message__aside">
                                            <a href="student-profile.php" class="avatar">
                                        ...
                                        <div class="message__body card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex mr-3">
                                                        <a href="student-profile.php" class="text-body"><strong>Kananura Kenny</strong></a>
                                                    </div>
                                                    <div>
                                    ...
                                    <li class="message d-inline-flex">
                                        ...
                                        <div class="message__body card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex mr-3">
                                                        <a href="student-profile.php" class="text-body"><strong>Manzi Christian</strong></a>
                                                    </div>
                                                    <div>
                                                        <small class="text-muted">5 minutes ago</small>
                                                    </div>
                                        ...
                                        <li class="list-group-item px-4 py-3 bg-light">
                                            <a href="#" class="d-flex align-items-center position-relative">
                                                <span class="avatar avatar-sm avatar-online mr-3 flex-shrink-0">
                                                    ...
                                                    <img src="assets/images/people/50/person.png" alt="Avatar" class="avatar-img rounded-circle">
                                        ...
                                        <li class="list-group-item px-4 py-3">
                                            <a href="#" class="d-flex align-items-center position-relative">
                                                <span class="avatar avatar-sm avatar-online mr-3 flex-shrink-0">
                                                    ...
                                                    <img src="assets/images/people/50/woman-2.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                        ...
                                        <li class="list-group-item px-4 py-3">
                                            <a href="#" class="d-flex align-items-center position-relative">
                                                <span class="avatar avatar-sm avatar-offline mr-3 flex-shrink-0">
                                                    ...
                                                    <img src="assets/images/people/50/woman-1.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                        ...
                                        <li class="list-group-item px-4 py-3">
                                            <a href="#" class="d-flex align-items-center position-relative">
                                                <span class="avatar avatar-sm avatar-offline mr-3 flex-shrink-0">
                                                    ...
                                                    <img src="assets/images/people/50/woman-3.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                        ...
                                        <li class="list-group-item px-4 py-3 bg-light">
                                            <a href="#" class="d-flex align-items-center position-relative">
                                                <span class="avatar avatar-sm avatar-offline mr-3 flex-shrink-0">
                                                    ...
                                                    <img src="assets/images/people/50/guy-1.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                        ...
                                        <li class="list-group-item px-4 py-3">
                                            <a href="#" class="d-flex align-items-center position-relative">
                                                <span class="avatar avatar-sm avatar-offline mr-3 flex-shrink-0">
                                                    ...
                                                    <img src="assets/images/people/50/guy-3.jpg" alt="Avatar" class="avatar-img rounded-circle">
      ...
      'fixed': 'fixed-student-messages-2.html',
      'default': 'student-messages-2.html'
                ...
                <div class="sidebar-p-y">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="sidebar-menu-item open">
                            ...
                            <ul class="sidebar-submenu sm-indent collapse show" id="messages_menu">
                                <li class="sidebar-menu-item">
        ...
        <a class="sidebar-menu-button" href="ui-modals.php">
          <span class="sidebar-menu-text">- Modals</span>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="fixed-student-messages-2.php">
    ...
    <div class="message__body card">
      <div class="card-body">
        <div class="d-flex align-items-center">
          <div class="flex mr-3">
            <a href="student-profile.php" class="text-body"><strong>{{:name}}</strong></a>
          </div>
          <div>
...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/student-messages-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:11:50 GMT -->
</html>