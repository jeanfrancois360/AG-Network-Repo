...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/student-forum-thread.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:10:41 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Student - Forum thread</title>
    ...
    <link rel="stylesheet" href="assets/css/summernote.rtl.css">
...
<body class=" layout-fluid">
    ...
    <div class="mdk-header-layout js-mdk-header-layout">
                ...
                <div class="mdk-drawer-layout__content page ">
                    ...
                    <div class="container-fluid page__container">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="student-forum.php">Forum</a></li>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <p class="text-muted d-flex align-items-center mb-4">
                                    <a href="student-forum.php" class="mr-3">Back to Community</a>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex">
                                            <p class="d-flex align-items-center mb-2">
                                                <a href="student-profile.php" class="text-body mr-2"><strong>Jenell D. Matney</strong></a>
                                ...
                                <div class="d-flex mb-4">
                                    <a href="student-profile.php" class="avatar mr-3">
                                ...
                                <div class="pt-3">
                                    ...
                                    <div class="d-flex mb-3">
                                        <a href="student-profile.php" class="avatar avatar-xs mr-3">
                                        ...
                                        <div class="flex">
                                            ...
                                            <span class="text-black-50">on <a href="student-take-course.php" class="text-black-50" style="text-decoration: underline;">Data Visualization With Chart.js</a></span><br>
                                            <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex ml-sm-32pt mt-3 border rounded p-3 bg-light mb-3">
                                        ...
                                        <div class="flex">
                                            <div class="d-flex align-items-center">
                                                <a href="student-profile.php" class="text-body"><strong>FrontendMatter</strong></a>
        ...
        <a class="sidebar-menu-button" href="ui-modals.php">
          <span class="sidebar-menu-text">- Modals</span>
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="fixed-student-forum-thread.php">
      ...
      'fixed': 'fixed-student-forum-thread.html',
      'default': 'student-forum-thread.html'
...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/student-forum-thread.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:10:46 GMT -->
</html>