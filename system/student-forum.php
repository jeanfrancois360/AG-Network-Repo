...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/student-forum.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:09:45 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    ...
                                    <a href="student-forum-ask.php" class="btn btn-success">Ask a Question</a>
                                </div>
                                    ...
                                    <ul class="list-group list-group-fit">
                                            ...
                                            <div class="media align-items-center">
                                                <div class="media-left">
                                                    <div class="forum-icon-wrapper">
                                                        <a href="student-forum-thread.php" class="forum-thread-icon">
                                                            <i class="material-icons">description</i>
                                                        </a>
                                                        <a href="student-profile.php" class="forum-thread-user">
                                                ...
                                                <div class="media-body">
                                                    <div class="d-flex align-items-center">
                                                        <a href="student-profile.php" class="text-body"><strong>Luci Bryant</strong></a>
                                                        <small class="ml-auto text-muted">5 min ago</small>
                                                    </div>
                                                    <a class="text-black-70" href="student-forum-thread.php">Am I learning the right way?</a>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li class="list-group-item forum-thread">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <div class="d-flex align-items-center">
                                                        <a href="student-profile.php" class="text-body"><strong>Magnus Goldsmith</strong></a>
                                                        <small class="ml-auto text-muted">7 min ago</small>
                                                    </div>
                                                    <a class="text-black-70" href="student-forum-thread.php">Can someone help me with the basic Setup?</a>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li class="list-group-item forum-thread">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <div class="d-flex align-items-center">
                                                        <a href="student-profile.php" class="text-body"><strong>Katelyn Rankin</strong></a>
                                                        <small class="ml-auto text-muted">12 min ago</small>
                                                    </div>
                                                    <a class="text-black-70" href="student-forum-thread.php">I think this is the right way?</a>
                                                </div>
                                            </div>
                                        </li>
                                    ...
                                    <ul class="list-group list-group-fit">
                                        ...
                                        <li class="list-group-item forum-thread">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <div class="d-flex align-items-center">
                                                        <a href="student-profile.php" class="text-body"><strong>Jenell D. Matney</strong></a>
                                                        <small class="ml-auto text-muted">1 min ago</small>
                                                    </div>
                                                    <a class="text-black-70" href="student-forum-thread.php">Getting around AngularJS</a>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li class="list-group-item forum-thread">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <div class="d-flex align-items-center">
                                                        <a href="student-profile.php" class="text-body"><strong>Sherri J. Cardenas</strong></a>
                                                        <small class="ml-auto text-muted">3 min ago</small>
                                                    </div>
                                                    <a class="text-black-70" href="student-forum-thread.php">Responsive Bootstrap Question</a>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li class="list-group-item forum-thread">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <div class="d-flex align-items-center">
                                                        <a href="student-profile.php" class="text-body"><strong>Joseph S. Ferland</strong></a>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <a href="student-profile.php" class="avatar avatar-sm mr-3">
                                            <img src="assets/images/people/50/guy-1.jpg" alt="course" class="avatar-img rounded-circle">
                                        </a>
                                        <a href="student-profile.php" class="flex mr-2 text-body"><strong>Luci Bryant</strong></a>
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <a href="student-profile.php" class="flex mr-2 text-body"><strong>Magnus Goldsmith</strong></a>
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <a href="student-profile.php" class="flex mr-2 text-body"><strong>Katelyn Rankin</strong></a>
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <a href="student-profile.php" class="flex mr-2 text-body"><strong>Jenell D. Matney</strong></a>
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <a href="student-profile.php" class="flex mr-2 text-body"><strong>Sherri J. Cardenas</strong></a>
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <a href="student-profile.php" class="flex mr-2 text-body"><strong>Joseph S. Ferland</strong></a>
                        ...
                        <div class="sidebar sidebar-left sidebar-dark bg-dark o-hidden" data-perfect-scrollbar>
                            <div class="sidebar-p-y">
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="sidebar-menu-item">
                                        ...
                                        <ul class="sidebar-submenu sm-indent collapse" id="messages_menu">
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="student-messages.php">
                                            ...
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="student-messages-2.php">
                                ...
                                <ul class="sidebar-menu sm-active-button-bg">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="student-take-quiz.php">
                                            <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">dvr</i> Take a Quiz
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="student-quiz-results.php">
                                    ...
                                    <li class="sidebar-menu-item open">
                                        ...
                                        <ul class="sidebar-submenu sm-indent collapse show" id="forum_menu">
                                            <li class="sidebar-menu-item active">
                                                <a class="sidebar-menu-button" href="student-forum.php">
                                                    <span class="sidebar-menu-text">Forum</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="student-forum-thread.php">
                                                    <span class="sidebar-menu-text">Discussion</span>
                                                </a>
                                            </li>
                                            <li class="sidebar-menu-item">
                                                <a class="sidebar-menu-button" href="student-forum-ask.php">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="student-help-center.php">
        ...
        <a class="sidebar-menu-button" href="ui-modals.php">
          <span class="sidebar-menu-text">- Modals</span>
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="fixed-student-forum.php">
...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/student-forum.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:09:59 GMT -->
</html>