...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/student-account-billing-upgrade.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:10:27 GMT -->
<head>
    <meta charset="utf-8">
...
<body class=" layout-fluid">
    ...
    <div class="mdk-header-layout js-mdk-header-layout">
                                ...
                                <div class="row card-group-row mb-40pt">
                                    <div class="col-lg-6 col-sm-6 card-group-row__col">
                                        ...
                                        <div class="card card-group-row__card text-center o-hidden card--raised navbar-shadow">
                                            ...
                                            <div class="card-footer">
                                                <a href="student-signup.php" class="btn btn-outline-secondary disabled">Current plan</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-sm-6 card-group-row__col">
                                        ...
                                        <div class="card card-group-row__card text-center o-hidden">
                                            ...
                                            <div class="card-footer">
                                                <a href="student-account-billing-payment-information.php" class="btn btn-success">Get started</a>
                                            </div>
                                        </div>
                                ...
                                <div data-perfect-scrollbar>
                                    <div class="page-section pt-lg-32pt">
                                        <ul class="nav page-nav__menu">
                                            ...
                                            <li class="nav-item">
                                                <a href="student-account-billing-upgrade.php" class="nav-link active">Upgrade Account</a>
                                            </li>
                                            <li class="nav-item">
        ...
        <a class="sidebar-menu-button" href="ui-modals.php">
          <span class="sidebar-menu-text">- Modals</span>
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="fixed-student-account-billing-upgrade.php">
      ...
      'fixed': 'fixed-student-account-billing-upgrade.html',
      'default': 'student-account-billing-upgrade.html'
...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/student-account-billing-upgrade.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:10:33 GMT -->
</html>