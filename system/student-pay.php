...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/student-pay.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:14:55 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Student - Pay</title>
...
<body class=" layout-fluid">
    ...
    <div class="mdk-header-layout js-mdk-header-layout">
          ...
          <span class="sidebar-menu-text">- Modals</span>
                                ...
                                <ul class="sidebar-menu">
                                    <li class="sidebar-menu-item active">
                                        <a class="sidebar-menu-button" href="student-pay.php">
                                            <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">dashboard</i> Fluid Layout
                                        </a>
                                    </li>
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="fixed-student-pay.php">
      ...
      'fixed': 'fixed-student-pay.html',
      'default': 'student-pay.html'
