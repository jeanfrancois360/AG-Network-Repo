...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/ui-nestable.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:13:29 GMT -->
<head>
    <meta charset="utf-8">
...
<body class=" layout-fluid ui">
    ...
    <div class="mdk-header-layout js-mdk-header-layout">
            ...
            <div data-push data-responsive-width="992px" class="mdk-drawer-layout js-mdk-drawer-layout">
                <div class="mdk-drawer-layout__content page ">
                    ...
                    <div class="container-fluid page__container">
                        ...
                        <h1 class="h2">Nestable</h1>
                        <p>Nestable is a component for hierarchical lists with drag &amp; drop capabilities, compatible with both mouse events and touch enabled devices.</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Primary Handles</h4>
                                    </div>
                                    <div class="card-body">
                                        <p>Primary color.</p>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Draggable Items</h4>
                                    </div>
                                    <div class="card-body">
        ...
        <a class="sidebar-menu-button" href="ui-modals.php">
          <span class="sidebar-menu-text">- Modals</span>
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="fixed-ui-nestable.php">
      ...
      'fixed': 'fixed-ui-nestable.html',
      'default': 'ui-nestable.html'
...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/ui-nestable.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:13:39 GMT -->
</html>