...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/instructor-help-center.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:15:18 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Instructor - Help center</title>
...
<body class=" layout-fluid">
    ...
    <div class="mdk-header-layout js-mdk-header-layout">
                    ...
                    <div class="container-fluid page__container">
                        ...
                        <div class="media mb-headings align-items-center">
                            ...
                            <div class="media-right">
                                <a href="instructor-forum-ask.php" class="btn btn-success">
        ...
        <a class="sidebar-menu-button" href="ui-modals.php">
          <span class="sidebar-menu-text">- Modals</span>
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="fixed-instructor-help-center.php">
      ...
      'fixed': 'fixed-instructor-help-center.html',
      'default': 'instructor-help-center.html'
...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/instructor-help-center.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:15:20 GMT -->
</html>