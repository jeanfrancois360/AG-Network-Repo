...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/instructor-forum-thread.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:15:14 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Instructor - Forum thread</title>
...
<body class=" layout-fluid">
    ...
    <div class="mdk-header-layout js-mdk-header-layout">
                ...
                <div class="mdk-drawer-layout__content page ">
                    ...
                    <div class="container-fluid page__container">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="instructor-forum.php">Forum</a></li>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <p class="text-muted d-flex align-items-center mb-4">
                                    <a href="instructor-forum.php" class="mr-3">Back to Community</a>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex">
                                            <p class="d-flex align-items-center mb-2">
                                                <a href="instructor-profile.php" class="text-body mr-2"><strong>Jenell D. Matney</strong></a>
                                ...
                                <div class="d-flex mb-4">
                                    <a href="instructor-profile.php" class="avatar mr-3">
                                ...
                                <div class="pt-3">
                                    ...
                                    <div class="d-flex mb-3">
                                        <a href="instructor-profile.php" class="avatar avatar-xs mr-3">
                                            <img src="assets/images/256_rsz_karl-s-973833-unsplash.jpg" alt="people" class="avatar-img rounded-circle">
                                        </a>
                                        <div class="flex">
                                            <a href="instructor-profile.php" class="text-body"><strong>Joseph S. Ferland</strong></a>
                                            <span class="text-black-70">How can I load Charts on a page?</span><br>
                                            <span class="text-black-50">on <a href="instructor-take-course.php" class="text-black-50" style="text-decoration: underline;">Data Visualization With Chart.js</a></span><br>
                                            <div class="d-flex align-items-center">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <a href="instructor-profile.php" class="flex mr-2 text-body"><strong>Luci Bryant</strong></a>
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <a href="instructor-profile.php" class="flex mr-2 text-body"><strong>Magnus Goldsmith</strong></a>
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <a href="instructor-profile.php" class="flex mr-2 text-body"><strong>Katelyn Rankin</strong></a>
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <a href="instructor-profile.php" class="flex mr-2 text-body"><strong>Jenell D. Matney</strong></a>
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <a href="instructor-profile.php" class="flex mr-2 text-body"><strong>Sherri J. Cardenas</strong></a>
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <a href="instructor-profile.php" class="flex mr-2 text-body"><strong>Joseph S. Ferland</strong></a>
                        ...
                        <div class="sidebar sidebar-left sidebar-dark bg-dark o-hidden" data-perfect-scrollbar>
                            <div class="sidebar-p-y">
                                ...
                                <ul class="sidebar-menu sm-active-button-bg">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="instructor-quizzes.php">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="instructor-statement.php">
        ...
        <a class="sidebar-menu-button" href="ui-modals.php">
          <span class="sidebar-menu-text">- Modals</span>
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="fixed-instructor-forum-thread.php">
      ...
      'fixed': 'fixed-instructor-forum-thread.html',
      'default': 'instructor-forum-thread.html'
...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/instructor-forum-thread.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:15:16 GMT -->
</html>