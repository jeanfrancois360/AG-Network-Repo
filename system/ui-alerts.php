...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/ui-alerts.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:12:49 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div class="mdk-header-layout js-mdk-header-layout">
                ...
                <div class="mdk-drawer-layout__content page ">
                    ...
                    <div class="container-fluid page__container">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>For a soft background, use one of the eight contextual classes i.e. <code>.alert-success</code>.</p>
        ...
        <strong>Dark - </strong> A simple dark alert - check it out!
                            ...
                            <div class="card-footer bg-dark">
                                ...
                                <code class="highlight html bg-dark">&lt;div&nbsp;class=&quot;alert&nbsp;alert-success&quot;&nbsp;role=&quot;alert&quot;&gt;<br />
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Strong background</h4>
                            </div>
                            <div class="card-body">
                                <p>For a stronger background color use the <code>.bg-*</code> classes and <code>.text-white.border-0</code>.</p>

                                <!-- <div class="alert bg-primary text-white border-0" role="alert">
        <strong>Primary - </strong> A simple primary alert - check it out!
      </div> -->

                                <!-- <div class="alert bg-secondary text-white border-0" role="alert">
        <strong>Secondary - </strong> A simple secondary alert - check it out!
      </div> -->
                                ...
                                <div class="alert bg-warning text-white border-0" role="alert">
                                    <strong>Warning!</strong> Better check yourself, you're not looking too good.
                                </div>
                                ...
                                <!-- <div class="alert bg-light border-0" role="alert">
        <strong>Light - </strong> A simple light alert - check it out!
      </div> -->
        ...
        <strong>Dark - </strong> A simple dark alert - check it out!
                            ...
                            <div class="card-footer bg-dark">
                                ...
                                <code class="highlight html bg-dark">&lt;div&nbsp;class=&quot;alert&nbsp;bg-info&nbsp;text-white&nbsp;border-0&quot;&nbsp;role=&quot;alert&quot;&gt;<br />
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer bg-dark">
                                ...
                                <code class="highlight html bg-dark">&lt;div&nbsp;class=&quot;alert&nbsp;alert-dismissible&nbsp;bg-primary&nbsp;text-white&nbsp;border-0&nbsp;fade&nbsp;show&quot;&nbsp;role=&quot;alert&quot;&gt;<br />
                                    &nbsp;&nbsp;&lt;button&nbsp;type=&quot;button&quot;&nbsp;class=&quot;close&quot;&nbsp;data-dismiss=&quot;alert&quot;&nbsp;aria-label=&quot;Close&quot;&gt;<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&lt;span&nbsp;aria-hidden=&quot;true&quot;&gt;&amp;times;&lt;/span&gt;<br />
                                    &nbsp;&nbsp;&lt;/button&gt;<br />
                                    &nbsp;&nbsp;&lt;strong&gt;Primary&nbsp;-&nbsp;&lt;/strong&gt;&nbsp;A&nbsp;simple&nbsp;primary&nbsp;alert&nbsp;-&nbsp;check&nbsp;it&nbsp;out!<br />
                                    &lt;/div&gt;</code>
        ...
        <a class="sidebar-menu-button" href="ui-modals.php">
          <span class="sidebar-menu-text">- Modals</span>
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="fixed-ui-alerts.php">
...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/ui-alerts.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:12:51 GMT -->
</html>