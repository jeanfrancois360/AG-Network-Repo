                ...
                <nav id="default-navbar" class="navbar navbar-expand navbar-dark bg-primary m-0">
                    <div class="container-fluid">
                        ...
                        <a href="instructor-dashboard.php" class="navbar-brand">
                            <img src="assets/images/logos/logo2.png" class="mr-2" width="100" height="80"
                                alt="LearnPlus" />
                        ...
                        <ul class="nav navbar-nav flex-nowrap">
                                            ...
                                            <a href="instructor-messages.php"
                                                ...
                                                <span class="d-flex">
                                                    <span class="avatar avatar-xs mr-2">
                                                        <img src="assets/images/people/110/person.png" alt="people"
                            ...
                            <li class="nav-item dropdown ml-1 ml-md-3">
                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button"><img
                                        src="assets/images/avatar/avatar.svg" alt="Avatar" class="rounded-circle"
                                        width="40"></a>
                                <div class="dropdown-menu dropdown-menu-right">
