...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/guest-signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:11:17 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div class="d-flex align-items-center" style="min-height: 100vh">
        <div class="col-sm-8 col-md-6 col-lg-4 mx-auto" style="min-width: 300px;">
            ...
            <div class="card navbar-shadow">
                ...
                <div class="card-footer text-center text-black-50">Already signed up? <a href="guest-login.php">Login</a></div>
            </div>
        </div>
    </div>
