...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/instructor-forum-ask.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:15:16 GMT -->
<head>
    <meta charset="utf-8">
...
<body class=" layout-fluid">
    ...
    <div class="mdk-header-layout js-mdk-header-layout">
                                        ...
                                        <ul class="list-group list-group-fit">
                                                ...
                                                <div class="media align-items-center">
                                                    <div class="media-left">
                                                        <div class="forum-icon-wrapper">
                                                            <a href="instructor-forum-thread.php" class="forum-thread-icon">
                                                                <i class="material-icons">description</i>
                                                            </a>
                                                            <a href="instructor-profile.php" class="forum-thread-user">
                                                    ...
                                                    <div class="media-body">
                                                        <div class="d-flex align-items-center">
                                                            <a href="instructor-profile.php" class="text-body"><strong>Luci Bryant</strong></a>
                                                            <small class="ml-auto text-muted">5 min ago</small>
                                                        </div>
                                                        <a class="text-black-70" href="instructor-forum-thread.php">Using Angular HttpClientModule instead of HttpModule</a>
                                                    </div>
                                                </div>
                                            </li>
                                            ...
                                            <li class="list-group-item forum-thread">
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <div class="d-flex align-items-center">
                                                            <a href="instructor-profile.php" class="text-body"><strong>Magnus Goldsmith</strong></a>
        ...
        <a class="sidebar-menu-button" href="ui-modals.php">
          <span class="sidebar-menu-text">- Modals</span>
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="fixed-instructor-forum-ask.php">
      ...
      'fixed': 'fixed-instructor-forum-ask.html',
      'default': 'instructor-forum-ask.html'
...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/instructor-forum-ask.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:15:18 GMT -->
</html>