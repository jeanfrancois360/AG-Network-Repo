...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/student-forum-ask.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:12:00 GMT -->
<head>
    <meta charset="utf-8">
...
<body class=" layout-fluid">
    ...
    <div class="mdk-header-layout js-mdk-header-layout">
                                ...
                                <form action="#">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group m-0" role="group" aria-labelledby="label-question">
                                                <div class="form-row align-items-center">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input id="question" type="text" placeholder="Your question ..." value="Angular HttpClientModule" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <li class="list-group-item forum-thread">
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <a class="text-black-70" href="student-forum-thread.php">Using Angular HttpClientModule instead of HttpModule</a>
                                                    </div>
                                                </div>
                                            </li>
                                    ...
                                    <div class="card">
                                        <div class="list-group list-group-fit">
                                            ...
                                            <div class="list-group-item">
                                                <button type="button" class="btn btn-success">Post Question</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <div data-perfect-scrollbar data-perfect-scrollbar-wheel-propagation="true">
                                    <div class="page-section pt-lg-32pt">
                                        ...
                                        <div class="page-nav__content">
                                            <p class="text-black-70">There may be other students who have asked the same question before.</p>
                                            <p class="text-black-70">You should do a quick search first to make sure your question is unique.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <a class="sidebar-menu-button" href="ui-modals.php">
          <span class="sidebar-menu-text">- Modals</span>
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="fixed-student-forum-ask.php">
      ...
      'fixed': 'fixed-student-forum-ask.html',
      'default': 'student-forum-ask.html'
...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/student-forum-ask.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:12:01 GMT -->
</html>