...
<head>
    ...
    <title>Facilitator - Edit account</title>
                        ...
                        <div class="tab-pane active" id="first">
                         ...
                         <div id="update_response"></div>             
                               <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="password" class="col-sm-3 col-form-label form-label">Course</label>
                                    <div class="col-sm-6 col-md-6">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                            ...
                                            <input type="text" id="course" name="course" class="form-control" value="">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="password" class="col-sm-3 col-form-label form-label">Payment Method</label>
                                    <div class="col-sm-6 col-md-6">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
    ...
    $.ajax({
        ...
        success: (response) => {
            $.each(JSON.parse(response), function(key, value){
                ...
                $("#payment_method").append('<option value="bank transfer" selected>Bank Transfer</option><option value="direct deposit">Direct Deposit</option><option value="mobile payment">Mobile Payments</option><option value="cash">Cash</option>');
                }
                else if(this.payment_method == "direct deposit"){
                $("#payment_method").append('<option value="bank transfer">Bank Transfer</option><option value="direct deposit" selected>Direct Deposit</option><option value="mobile payment">Mobile Payments</option><option value="cash">Cash</option>');
                }
                else if(this.payment_method == "mobile payment"){
                $("#payment_method").append('<option value="bank transfer">Bank Transfer</option><option value="direct deposit">Direct Deposit</option><option value="mobile payment" selected>Mobile Payments</option><option value="cash">Cash</option>');
                }
                else if(this.payment_method == "cash"){
                $("#payment_method").append('<option value="bank transfer">Bank Transfer</option><option value="direct deposit">Direct Deposit</option><option value="mobile payment">Mobile Payments</option><option value="cash" selected>Cash</option>');
                }
                else{
                $("#payment_method").append('<option value="no option">No option</option>');
                }
