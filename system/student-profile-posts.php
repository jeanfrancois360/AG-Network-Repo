...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/student-profile-posts.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:12:01 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Student Profile Posts</title>
...
<body class=" layout-fluid">
    ...
    <div class="mdk-header-layout js-mdk-header-layout">
                ...
                <div class="mdk-drawer-layout__content page pt-0">
                    ...
                    <div class="container-fluid page__container d-flex align-items-end position-relative mb-4">
                        ...
                        <ul class="nav nav-tabs-links flex" style="margin-left: 265px;">
                            <li class="nav-item">
                                <a href="student-profile.php" class="nav-link">Courses</a>
                            </li>
                            <li class="nav-item">
                                <a href="student-profile-posts.php" class="nav-link active">Posts</a>
                            </li>
                        </ul>
                    </div>
                                        ...
                                        <div class="d-flex mb-1">
                                            ...
                                            <div class="flex">
                                                <div class="d-flex align-items-center mb-1">
                                                    <strong class="text-15pt">Jimmy Carter</strong>
                                                    <small class="ml-auto text-muted">3 days ago</small>
                                                </div>
                                                <div>
                                                    <p>Thanks for contributing to the release of LearnPlus - Learning Management Template <a href="#">https://www.frontendmatter.com/themes/learnpl...</a> 🔥</p>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex mb-1">
                                            ...
                                            <div class="flex">
                                                <div class="d-flex align-items-center mb-1">
                                                    <strong class="text-15pt">Tonny Mugisha</strong>
        ...
        <a class="sidebar-menu-button" href="ui-modals.php">
          <span class="sidebar-menu-text">- Modals</span>
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="fixed-student-profile-posts.php">
      ...
      'fixed': 'fixed-student-profile-posts.html',
      'default': 'student-profile-posts.html'
...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/student-profile-posts.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Oct 2019 11:12:05 GMT -->
</html>